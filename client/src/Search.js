...
//     setLatlng("");
//     if (checked) {
//         const url = "https://ipinfo.io/207.151.52.62?token=feed184c1da5bd";
...
//     return (
//         <>
//           <div className="container col col-md-7">
//             <div className="card form-card" style={{ width: 620 }}>
//               <div className="card-body">
//                 <div id="heading">Events Search</div>
//                 <hr style={{ width: 570, borderTop: "2px solid", color: "white" }}></hr>
...
//                     <AsyncTypeahead id="basic-typeahead-single" options={options} size={"lg"} isLoading={isLoading} useCache={false}
...
//                         <input className="form-control form-control-lg" placeholder="10" onChange={(e) => setDistance(e.target.value)} name="distance" value={distance || 20}>
//                         </input>
//                       </div>
//                       <div className="form-group mt-4 mb-md-4 col-md-6">
